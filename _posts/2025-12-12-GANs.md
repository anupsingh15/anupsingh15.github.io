...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9DZQE2MMKS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9DZQE2MMKS');
</script>

### **1. What does a generative model do?** 
...
### **2. General Principles of Generative Models**
...
An overview of a typical generative modelling framework is as follows:
...
1. Computing the f-divergence directly is intractable in high dimensional space. 
